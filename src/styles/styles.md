...
| `--chart-1`              | Chart series color 1 (teal)               |
| `--chart-2`              | Chart series color 2 (amber)              |
| `--chart-3`              | Chart series color 3 (yellow)             |
| `--chart-4`              | Chart series color 4 (neutral dark)       |
| `--chart-5`              | Chart series color 5 (neutral mid)        |
| `--success`              | Success state color (green)               |
| `--warning`              | Warning state color (yellow)              |
| `--radius`               | Border radius (0.75rem default)           |
| `--heatmap-zero`         | Heatmap empty cell color (rgb, not OKLCH) |
