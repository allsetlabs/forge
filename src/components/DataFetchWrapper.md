...
<DataFetchWrapper
  ...
  emptyIcon={<ShoppingCart className="text-muted-foreground h-16 w-16" aria-hidden="true" />}
>
...
<DataFetchWrapper
  ...
  emptyTitle="No Messages"
  emptyMessage="Your inbox is empty"
  emptyIcon={<Inbox className="text-muted-foreground h-16 w-16" aria-hidden="true" />}
>
