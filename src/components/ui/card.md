...
- **Semantic Structure**: Pre-built components for header, title, description, content, footer, and action
...
Action element positioned in the top-right corner of the card using CSS grid layout.
