...
- **Multiple Variants**: 7 pre-built style variants (default, destructive, outline, secondary, ghost, link, overlay)
- **Flexible Sizing**: 6 size options (default, sm, lg, icon, iconSm, icon-sm)
...
| ----------- | ------------------------------------------------------------------------------------------ | ----------- | --------------------------------------------------------- |
| `variant`   | `"default" \| "destructive" \| "outline" \| "secondary" \| "ghost" \| "link" \| "overlay"` | `"default"` | Visual style variant                                      |
| `size`      | `"default" \| "sm" \| "lg" \| "icon" \| "iconSm" \| "icon-sm"`                             | `"default"` | Button size                                               |
...
```tsx
<Button variant="overlay">Overlay Button</Button>
```

**Visual:**

> Semi-transparent black background (50% opacity), white text, hover darkens to 70% opacity. Perfect for buttons over images or videos.
...
> Small circular button (h-8 w-8 rounded-full), compact icon button for tight spaces
...
> Compact square button (h-7 w-7 rounded-md), smallest icon button for dense UI areas
