...
> A small popup appears instantly above the button on hover, showing the tooltip text with a primary color background and primary-foreground text
...
```tsx
<TooltipProvider>{/* Your tooltips here */}</TooltipProvider>
```
...
> Tooltip appears instantly above the button with primary color background and primary-foreground text
...
<TooltipProvider>
  <Tooltip>
    ...
    <TooltipContent className="max-w-xs">
      <p className="text-sm">This is a longer tooltip with custom max-width and smaller text</p>
    </TooltipContent>
  </Tooltip>
</TooltipProvider>
```
...
- **Styling**: Uses primary color background (`bg-primary`) with `text-primary-foreground` — not popover background
